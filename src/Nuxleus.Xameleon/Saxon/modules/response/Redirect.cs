...
namespace myxsl.net.saxon.modules.response {
   ...
   sealed class Redirect : ExtensionFunctionDefinition {
      ...
      public Redirect() {
         ...
         this._FunctionName = new QName(ResponseModule.Namespace, "redirect");
      ...
      class FunctionCall : ExtensionFunctionCall {
         ...
         public override IXdmEnumerator Call(IXdmEnumerator[] arguments, DynamicContext context) {
            ...
            string url = arguments[0].AsAtomicValues().Single().ToString();
