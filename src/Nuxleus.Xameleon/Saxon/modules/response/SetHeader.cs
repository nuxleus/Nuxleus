...
namespace myxsl.net.saxon.modules.response {
   ...
   sealed class SetHeader : ExtensionFunctionDefinition {
      ...
      public SetHeader() {
         ...
         this._FunctionName = new QName(ResponseModule.Namespace, "set-header");
      ...
      class FunctionCall : ExtensionFunctionCall {
         ...
         public override IXdmEnumerator Call(IXdmEnumerator[] arguments, DynamicContext context) {
            ...
            string value = arguments[1].AsAtomicValues().Single().ToString();
