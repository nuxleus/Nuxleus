...
namespace myxsl.net.saxon.modules.request {
   ...
   sealed class UrlAppRelativePath : ExtensionFunctionDefinition {
      ...
      public UrlAppRelativePath() {

         this._FunctionName = new QName(RequestModule.Namespace, "url-app-relative-path");
      ...
      class FunctionCall : ExtensionFunctionCall {
         ...
         public override IXdmEnumerator Call(IXdmEnumerator[] arguments, DynamicContext context) {
            ...
            XdmValue result = RequestModule.UrlAppRelativePath().ToXdmValue();
