...
namespace myxsl.net.saxon {
   ...
   public static class SaxonExtensions {
      ...
      public static IXdmEnumerator GetXdmEnumerator(this XdmValue value) {
         return (IXdmEnumerator)(value ?? XdmEmptySequence.INSTANCE).GetEnumerator();
      }
      ...
      static XdmAtomicValue ToXdmAtomicValue(this object value, Type type, TypeCode typeCode, Processor processor) {
         ...
         switch (Type.GetTypeCode(type)) {
            ...
            case TypeCode.DateTime:
               return new XdmAtomicValue(XmlConvert.ToString((DateTime)value, XmlDateTimeSerializationMode.Unspecified), new QName(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.DateTime).QualifiedName), processor);
