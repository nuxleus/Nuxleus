...
namespace Nuxleus.Web.Module.EXPath.HttpClient {
   ...
   public sealed class XPathHttpBody {
      ...
      public XmlQualifiedName Method {
         get {
            if (_Method != null)
               return _Method;
            return XmlSerializationOptions.Methods.Xml;
         }
         set { _Method = value; }
      }
      ...
      static XmlQualifiedName GetMethodFromMediaType(string mediaType, XmlQualifiedName defaultValue) {
         ...
         if (MediaTypes.Equals(mediaType, MediaTypes.XHtml))
            return XmlSerializationOptions.Methods.XHtml;
         
         if (MediaTypes.IsXml(mediaType))
            return XmlSerializationOptions.Methods.Xml;
         
         if (MediaTypes.Equals(mediaType, MediaTypes.Html))
            return XmlSerializationOptions.Methods.Html;
      ...
      public static class ExtensionMethods { 
         ...
         static readonly XmlQualifiedName _Base64Binary, _HexBinary;
         ...
         static ExtensionMethods() {
            ...
            _Base64Binary = new XmlQualifiedName("base64Binary", XPathHttpClient.Namespace);
            _HexBinary = new XmlQualifiedName("hexBinary", XPathHttpClient.Namespace);
         }
      } 
