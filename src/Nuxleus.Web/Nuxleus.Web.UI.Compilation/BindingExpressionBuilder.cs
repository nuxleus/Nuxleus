...
namespace Nuxleus.Web.UI.Compilation {
   ...
   public abstract class BindingExpressionBuilder {
      ...
      public static BindingExpressionInfo ParseExpr(string expression, BindingExpressionContext context) {
         ...
         ExpressionBuilderElement el = LibraryConfigSection.Instance.ExpressionBuilders.Get(ns);
      ...
      public static string[] GetNamespaces() {
         return LibraryConfigSection.Instance.ExpressionBuilders.Cast<ExpressionBuilderElement>().Select(e => e.Namespace).ToArray();
      }
