...
namespace Nuxleus.Web {
   ...
   public class XmlSerializationOptions {
      ...
      static XmlSerializationOptions() {
      ...
      public static explicit operator XmlWriterSettings(XmlSerializationOptions options) {
      ...
      static void CopyTo(XmlSerializationOptions options, XmlWriterSettings settings) {
         ...
         if (options.Method != null 
            ...
            && options.Method != Methods.Xml) {

            if (options.Method == Methods.Html)
               setOutputMethod(settings, XmlOutputMethod.Html);

            else if (options.Method == Methods.Text)
      ...
      public static class Methods {
         ...
         static readonly XmlQualifiedName _Xml, _Html, _XHtml, _Text;
         ...
         static Methods() {
            ...
            _Xml = new XmlQualifiedName("xml");
            _Html = new XmlQualifiedName("html");
            _XHtml = new XmlQualifiedName("xhtml");
            _Text = new XmlQualifiedName("text");
         }
      }
